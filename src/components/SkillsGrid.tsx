...
const skillCategories = [
  {
    ...
    skills: [
      ...
      { name: "NestJS / Fastify", icon: Server, size: "medium" },
      { name: "TypeScript", icon: Code2, size: "small" },
      { name: "Python", icon: FileCode, size: "small" },
      { name: "Prisma ORM", icon: Box, size: "small" },
    ]
  },
  {
    ...
    skills: [
      ...
      { name: "Apache Airflow", icon: Workflow, size: "medium" },
      { name: "PostgreSQL / Supabase", icon: Database, size: "medium" },
      { name: "Gemini API", icon: Sparkles, size: "medium" },
      { name: "LLM Orchestration", icon: Brain, size: "large" },
    ]
  },
  {
    ...
    skills: [
      ...
      { name: "Vercel / Render", icon: Globe, size: "medium" },
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="space-y-16 max-w-7xl mx-auto">
          {skillCategories.map((category, catIndex) => (
            <div key={catIndex}>
              <h3 className="text-brand-yellow font-bebas text-3xl mb-8 border-l-4 border-brand-yellow pl-4">
                {category.title}
              </h3>
